      ...
      <StickyHeader>
        ...
        <div className="max-w-5xl mx-auto px-5 pt-[max(env(safe-area-inset-top),0.75rem)] pb-3">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/me">
              <Button variant="ghost" size="icon" className="rounded-full w-10 h-10 mr-12 bg-white dark:bg-[#1C1C1E] border border-black/[0.06] dark:border-white/10 hover:scale-95 transition-transform">
