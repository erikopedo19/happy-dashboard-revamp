"use client";
// Adapted from shadcn registry: delete-button
// Original used @phosphor-icons/react; swapped to lucide-react for this project.
        ...
        <AnimatePresence initial={false} mode="popLayout">
          ...
          {deletionState === "counting" && (
            ...
            >
              ...
              >
                <Undo2 size="1.1em" aria-hidden="true" />
              </motion.button>
          ...
          {deletionState === "deleted" && (
            ...
            >
              <span className="grid size-5 place-items-center rounded-full bg-stone-500 text-white shadow-[inset_0_2px_0_rgba(255,255,255,0.3)] dark:bg-stone-600 dark:shadow-[inset_0_2px_0_rgba(255,255,255,0.15)]">
                <Check size="0.9em" aria-hidden="true" />
              </span>
              Account Deleted
            </motion.div>
          )}
