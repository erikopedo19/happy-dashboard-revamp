  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "sm:inset-auto sm:bottom-auto sm:left-1/2 sm:top-1/2 sm:max-h-[85vh] sm:w-full sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 sm:gap-4 sm:rounded-2xl sm:border sm:p-6",
    ...
    >
      ...
      <div className="mx-auto mb-3 h-1.5 w-10 rounded-full bg-muted-foreground/25 sm:hidden" />
      {children}
