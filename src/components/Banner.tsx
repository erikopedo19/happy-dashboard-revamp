    ...
    switch (variant) {
      ...
      case "warning":
        return {
          ...
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: "text-sm font-medium text-yellow-800 dark:text-yellow-200 leading-tight",
          description: "text-xs text-yellow-700 dark:text-yellow-300",
          actions:
            "flex items-center justify-center md:justify-start gap-2 sm:self-auto pr-12",
        };
      case "success":
        return {
          ...
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: "text-sm font-medium text-green-800 dark:text-green-200 leading-tight",
          description: "text-xs text-green-700 dark:text-green-300",
          actions:
            "flex items-center justify-center md:justify-start gap-2 sm:self-auto pr-12",
        };
      case "info":
        return {
          ...
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: "text-sm font-medium text-blue-800 dark:text-blue-200 leading-tight",
          description: "text-xs text-blue-700 dark:text-blue-300",
          actions:
            "flex items-center justify-center md:justify-start gap-2 sm:self-auto pr-12",
        };
      case "announcement":
        return {
          ...
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: "text-sm font-medium text-purple-800 dark:text-purple-200 leading-tight",
          description: "text-xs text-purple-700 dark:text-purple-300",
          actions:
            "flex items-center justify-center md:justify-start gap-2 sm:self-auto pr-12",
        };
      default:
